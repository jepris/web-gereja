        ...
        <section>
            <div class="layanan">
                <div class="layanan-isi">
                    ...
                    <ul>
                        <li class="mb-3">Pendaftaran Jemaat Baru <button type="button" class="btn btn-primary" ><a href="/hurias/newjemaat">
                            disini . . .</a>
                          </button></li>
                        <li class="mb-3">Pemberitahuan Anak Lahir <button type="button" class="btn btn-primary" ><a href="/hurias/newbaby">
                          disini . . .</a>
                          </button></li>
