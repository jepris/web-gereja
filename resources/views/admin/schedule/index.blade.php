                                ...
                                <td class="text-center">
                                    <div class="action">
                                        ...
                                        <button class="btn btn-warning" data-toggle="modal"
                                            data-target="#editModal{{ $schedule->id }}">Edit</button>
                                        <button class="btn btn-danger" data-toggle="modal"
                                            data-target="#deleteModal{{ $schedule->id }}">Hapus</button>
                                    </div>
                                </td>
                            </tr>
                            <!-- Edit Modal -->
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="editModalLabel{{ $schedule->id }}">Edit Jadwal
                                                Ibadah</h5>
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('schedule.update', $schedule->id) }}" method="POST">
                                                ...
                                                @method('PUT')
                                                <div class="mb-3">
                                                    <label for="ibadah" class="form-label fw-bold">Nama Ibadah</label>
                                                    <input type="text" value="{{ $schedule->nama_ibadah }}"
                                                        class="form-control" name="nama_ibadah" id="ibadah" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="hari" class="form-label fw-bold">Hari</label>
                                                    <input type="text" value="{{ $schedule->hari }}" class="form-control"
                                                        name="hari" id="hari" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="jam" class="form-label fw-bold">Jam</label>
                                                    <input type="text" value="{{ $schedule->jam }}" class="form-control"
                                                        name="jam" id="jam" required>
                                                </div>
                                                <label for="keterangan" class="form-label fw-bold">Keterangan</label>
                                                <input type="text" value="{{ $schedule->keterangan }}"
                                                    class="form-control" name="keterangan" id="keterangan" required>
                                        </div>

                                        <div class="modal-footer">
                                            <button type="submit" class="btn btn-succss">Simpan</button>
                                        </div>
                                        </form>
                                    </div>
                                </div>
