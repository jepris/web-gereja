...
@section('content')
    <section class="content">
        <div class="container-fluid">
            <h3 class="mt-3 fw-bold">Kontak Keluhan  HKBP Perumnas Batu Onom</h3>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="action d-flex justify-content-center">
                                        ...
                                        <form action="{{ route('kontaks.destroykontak', $data->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <div class="form-judul">
                            <h4 class="card-title fw-bold d-flex justify-content-center">Edit Kontak Keluhan</h4>
                        </div>
                        <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                    <form action="{{ route('kontaks.updatekontak', $data->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="perihal" class="form-control" id="perihal" required>{{ $data->perihal }}</textarea>
                        </div>
                        <div class="mb-3">
