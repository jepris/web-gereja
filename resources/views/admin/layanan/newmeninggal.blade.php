...
@section('content')
    <section class="content">
        <div class="container-fluid">
            <h3 class="mt-3 fw-bold">Jemaat Meninggal  HKBP Perumnas Batu Onom</h3>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="action d-flex justify-content-center">
                                        ...
                                        <form action="{{ route('meninggals.destroymeninggal', $data->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
        ...
        <div class="modal fade" id="editdata{{ $data->id }}" tabindex="-1"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('meninggals.updatemeninggal', $data->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="alamat" class="form-control" value="{{ $data->alamat }}" id="alamat" required></input>
                        </div>
                        <div class="mb-3">
