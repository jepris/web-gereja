        ...
        <div class="card mt-4">
            <div class="card-body">
                <div class="form-judul">
                    <h4 class="card-title fw-bold d-flex justify-content-center">Pemberitahuan Jemaat Sakit HKBP Perumnas Batu Onom</h4>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="exampleFormControlTextarea1" class="form-label fw-bold">Info Anggota Keluarga yang Sakit</label>
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="4" placeholder="Nama/Gender/Alamat rumah | Rumah Sakit + No.kamar"></textarea>
                </div>
