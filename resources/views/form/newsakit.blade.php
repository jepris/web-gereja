            ...
            <div class="col-8">
                ...
                <form action="">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="keterangan" id="exampleFormControlTextarea1" rows="4" placeholder="Nama/Gender/Alamat rumah | Rumah Sakit + No.kamar" required></textarea>
                    </div>
