...
@section('content')
    <div class="container mt-2 mb-4">
        <div class="formulir d-flex justify-content-center">
            <div class="col-8">
                <h4 class="text-center fw-bold mb-5">Formulir Pendataan Jemaat Sakit</h4>
                <form action="{{ route('hurias.storesakit') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="keterangan" class="form-label fw-bold">Info Anggota Keluarga yang Sakit</label>
                        <textarea class="form-control" name="keterangan" id="keterangan" rows="4" placeholder="Nama/Gender/Alamat rumah | Rumah Sakit + No.kamar" required></textarea>
                    </div>
