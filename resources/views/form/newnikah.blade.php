    ...
    <div class="container mt-2 mb-4">
        <div class="formulir d-flex justify-content-center">
            <div class="col-8">
                ...
                <form action="{{ route('hurias.storenikah') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="keterangan" class="form-label fw-bold">Info Anggota Keluarga yang Akan Menikah & Pasangan</label>
                        <textarea class="form-control" name="keterangan" id="keterangan" rows="4" placeholder="(cth : Chandra Silaban/Pria/28 Mei 1997 dengan Rumiati Marpaung/Wanita/16 September 1998)" required></textarea>
                    </div>
