        ...
        <div class="card mt-4">
            <div class="card-body">
                <div class="form-judul">
                    <h4 class="card-title fw-bold d-flex justify-content-center">Pendaftaran Pembaptisan HKBP Perumnas Batu Onom</h4>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="exampleFormControlTextarea1" class="form-label fw-bold">Info anggota keluarga yang akan baptis (Nama/gender/tanggal lahir)</label>
