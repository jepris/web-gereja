    ...
    <div class="container mt-2 mb-4">
        <div class="formulir d-flex justify-content-center">
            <div class="col-8">
                ...
                <form action="{{ route('hurias.storepindah') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="tujuan" class="form-label fw-bold">Gereja Tujuan / Wijk</label>
                        <input type="text" name="tujuan" class="form-control" id="tujuan" placeholder="HKBP PErumnas/11" required>
                    </div>
