...
<head>
    ...
    <title>Tentang - Huria Kristen Batak Protestan Perumnas Batu Onom</title>
...
<body>
    <nav class="navbar navbar-expand-lg border-bottom border-2 border-primary mb-3">
        <div class="container">
            <a class="navbar-brand" href="#"><img src="/img/logo hkbp.png" alt="Logo">HKBP Perumnas Batu Onom</a>
    ...
    <footer>
        <p>All Rights Reserved. © 2018 HKBP PERUMNAS BATU ONOM</p>
