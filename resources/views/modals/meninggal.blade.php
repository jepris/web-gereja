<div class="modal fade" id="meninggal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title fw-bold d-flex justify-content-center" id="baptis">Pendataan Jemaat meninggal <br>HKBP
            ...
            <div class="modal-body">
                <form action="">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="4" placeholder="Nama/Gender/tanggal lahir"></textarea>
                    </div>
                </form>
            </div>
